  ...
  try {
    ...
    return {
      ...
      openGraph: {
        ...
        ? data.FldNameImageKalaList.split(",").map((img: string) => ({ url: `/assets/public/kala/${params.id}/${img.trim()}` }))
      ...
      alternates: {
        canonical: `https://imbmi.ir/productDetails/${params.id}/${params.name}`,
      },
    };
  } catch (err) {
...
export default function ProductPage({ params }: { params: { id: string; name: string } }) {
